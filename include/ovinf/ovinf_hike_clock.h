...
#ifndef OVINF_HIKE_CLOCK_H
#define OVINF_HIKE_CLOCK_H
 ...
 */
class HikeClockPolicy : public BasePolicy<float> {
 ...
 public:
  HikeClockPolicy() = delete;
  ~HikeClockPolicy();

  HikeClockPolicy(const YAML::Node &config);
